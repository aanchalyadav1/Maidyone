                ...
                {workers && workers.length > 0 ? workers.map((item, index) => {
                  return (
                    <tr key={item._id || index} className="border-b border-gray-50 hover:bg-gray-50/50 transition border-opacity-50">
                      ...
                      <td className="py-3 px-4 text-[12px] text-[#6B7280] hidden sm:table-cell truncate max-w-[100px]">{item.user?.phoneNumber || "-"}</td>
                      ...
                      <td className="py-3 px-4 text-[12px] text-[#6B7280] hidden md:table-cell truncate max-w-[150px]">{item.user?.address || "-"}</td>
